...
<%
    ...
    QuizQuestion quizquestion = (QuizQuestion) request.getAttribute("quizquestion");
    String question = (String) request.getAttribute("question");
    String explanation = (String) request.getAttribute("explanation");
    Part filePart = (Part) request.getAttribute("filePart");
    List<QuizQuestionChoice> choiceList = (List<QuizQuestionChoice>) request.getAttribute("choiceList");
    ...
    <div class="wrap-content">
        ...
        <div class="homeContainer">
            <form action="editquestion" method="post" enctype="multipart/form-data">
                <input type="text" name="go" value="editQuestion" style="display: none">
                <input type="text" name="questionID" value="<%=quizquestion.getQuestionID()%>" style="display: none">
                <table id="addQtbl">
                    <tr>
                    ...
                    <tr>
                        <td><input type="text" name="question"
                                   value="<%=(quizquestion.getQuestionText()==null?"":quizquestion.getQuestionText())%>">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><input type="text" name="explanation"
                                   value="<%=(quizquestion.getExplanation()==null?"":quizquestion.getExplanation())%>">
                        </td>
                    </tr>
                    <tr>
                        <td><p>At least 6 character required</p></td>
                    ...
                    <tr>
                        <td><input name="picture" type="file"
                                   value="<%= quizquestion.getPicture()==null?"":quizquestion.getPicture() %>"/></td>
                    </tr>
                    <%for (int i = 0; i < choiceList.size(); i++) {%>
                    <div class="<%=choiceList.get(i).getChoiceId()%>">
                        <tr>
                            <td><label for="choice">Choice</label></td>
                            <td><label for="weight">Weight</label></td>
                        </tr>
                        <tr>
                            <td><input type="text" name="choice" value="<%=choiceList.get(i).getChoiceText()%>"></td>
                            <td><input type="text" name="weight" value="<%=weight[i]%>"></td>
                        </tr>
                        <tr>
                            <td><p>At least 6 character required</p></td>
                        </tr>
                    ...
                    <tr class="submitBtnBox">
                        <td><input type="submit" class="submitBtn" name="submit" value="Edit Question"></td>
                    </tr>
                </table>
            </form>
        </div>
